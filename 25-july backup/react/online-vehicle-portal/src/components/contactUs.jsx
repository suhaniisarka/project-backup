  ...
  return (
    <>
      ...
      <div
        ...
        style={{ width: "450px", paddingTop: "30px" }}
      >
        <img
          ...
          <p style={{ color: "white", textShadow: "1px 1px #000000" }}>
            ...
            <div>
              <div>
                ...
                />
                <a style={{ fontSize: "22px", paddingTop: "2px" }}>
                  Email-Id: abcd@dummy.com
                </a>
              </div>
              <br />
              <div>
                ...
                />
                <a style={{ fontSize: "22px", paddingTop: "2px" }}>
                  Address: Building alpha, 3rd Floor, X street, ABC
                </a>
              </div>
              <br />
              <div>
